...
install.packages(
	"https://github.com/adamkocsis/icosa/raw/main/_archive/binaries/Win_x64_x86/icosa_0.11.0.zip", 
	repos=NULL)
```
...
```{r stable, eval=FALSE}
install.packages(
	"https://github.com/adamkocsis/icosa/raw/main/_archive/source/icosa_0.11.0.tar.gz", 
