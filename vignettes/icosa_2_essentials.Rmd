...
Note that this is just a brief introduction to the package's capabilities. The complete documentation of the package and the rest of the tutorials will be made available on the [package website](https://icosa-grid.github.io/R-icosa/). Relevant how-to guides will be posted on the evolv-ED blog (https://www.evolv-ed.net/). 
