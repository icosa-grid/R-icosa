...
```
install.packages(
  "https://github.com/adamkocsis/divDyn/raw/master/_archive/source/icosa.0.9.82.tar.gz", 
  repos=NULL, type="source")
```
3. I will also provide binaries for Windows. If you want to, you can try them. 
`install.packages("https://github.com/adamkocsis/divDyn/raw/master/_bin/Win_x64_x86/icosa_0.9.82.zip", repos=NULL)`
