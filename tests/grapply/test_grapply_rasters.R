...
# the tests
source(file.path(genericloc,"grapply/grapply_raster_density.R"), local=TRUE, print.eval=diag)
source(file.path(genericloc,"gridensity/gridensity_raster.R"), local=TRUE, print.eval=diag)
...
# the tests
source(file.path(genericloc,"grapply/grapply_raster_variable.R"), local=TRUE, print.eval=diag)
